...
function render (
  ...
  videoEntity.sprites.forEach(sprite => {
    ...
    drawSprite(webGL, sprite, currentFrame, bitmap, replaceElement, dynamicElement)
  })
}
...
function drawSprite (
  ...
  if (bitmap !== undefined) {
    ...
    if (replaceElement !== undefined) {
      console.log(123)
      webGL.drawImage(replaceElement, 0, 0, frame.layout.width, frame.layout.height)
    } else {
      webGL.drawImage(bitmap, 0, 0, frame.layout.width, frame.layout.height)
    }
  }

  if (dynamicElement !== undefined) {
    console.log(23)
    // webGL.drawImage(replaceElement, (frame.layout.width - dynamicElement.width) / 2, (frame.layout.height - dynamicElement.height) / 2, dynamicElement.width, dynamicElement.height)
  }
